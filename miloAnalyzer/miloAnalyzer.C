...
void miloAnalyzer(){
  ...
  TH1D * h3  =  new TH1D("1eEvents(normalized)","",bins,0,50);
  c1->cd(3);
  ...
  cout << std::accumulate(Nvector.begin(), Nvector.end(), 0.00) << endl
  cout << std::accumulate(counts.begin(), counts.end(), 0.00) << endl
  cout << std::accumulate(Nvector.begin(), Nvector.end(), 0.00) << endl
  cout << std::accumulate(counts.begin(), counts.end(), 0.00) << endl
  cout << std::accumulate(Nvector.begin(), Nvector.end(), 0.00) << endl
  cout << std::accumulate(counts.begin(), counts.end(), 0.00) << endl
